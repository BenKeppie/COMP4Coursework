...
class DisplaySkateparksWidget(QWidget):
    ...
    def unfreeze_add_trick(self):
        self.skatepark_name.setReadOnly(False)
        self.skatepark_description.setReadOnly(False)

    def clear_skatepark_line_edit(self):
        self.skatepark_name.setReadOnly(True)
        self.skatepark_description.setReadOnly(True)
    ...
    def add_skatepark(self):
        ...
        if not hasattr(self,"add_skatepark_map"):
            #self.add_skatepark_map=QPushButton("Teeeeeesssssttttttttttttttttttttttttttttttttttttttt")
