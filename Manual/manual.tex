...
\subsubsection{How Do I Change My Profile Email Address?} \label{ChangeEmail}
...
\subsubsection{How Do I Add a Trick?} \label{AddTrick}
...
\subsubsection{How Do I Delete a Trick?} \label{DeleteTrick}
...
\subsubsection{How Do I Add a Skatepark?} \label{AddSkatepark}
...
\subsubsection{How Do I Access Existing Skatepark Details?}\label{SkateparkDetails}
...
\subsubsection{How Do I Hide Skateparks?}  \label{HideSkatepark}
...
\subsubsection{How Do I Contact Support?} \label{ContactSupport}
...
\subsubsection{How Do I Add a Review?} \label{AddReview} %WALKTHROUGH TEXT AFTER COMMAND LINE INTERFACE
...
\subsection{Limitations} %DISCUSS LIMITATIONS MORE
