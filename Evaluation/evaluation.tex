...
\subsubsection {Display status bar messages at appropriate times to inform the user of changes *NEW*} %show some images
...
\subsubsection {Ensure that videos load correctly and are linked to the right video.} %Show images
...
\subsubsection {Ensure that videos are displayed at the correct size/resolution that the monitor of the computer is.} %Show images
